(function($) {
    ...
    $(document).ready(function($) {
        ...
        $.jribbble.setToken('a8d92fc651c2eff6eec692fc96bbe3e14fb384181cca954c080e8b238ac309fe');



        $.jribbble.users('munfactory').shots({ per_page: 36 }).then(function(shots) {
            var html = [];
            var $i = 0,
                $active = '';
            ...
            $('#carousel-dribbble .carousel-inner').html(html.join(''));
        });
